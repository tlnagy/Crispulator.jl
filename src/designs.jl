...
function run_growth(setup::ScreenSetup, lib::Library; run_idx=-1, testalg=false)
    ...
    bin_cells = growth_assay(cells, guides, setup.num_bottlenecks, setup.bottleneck_perc)
