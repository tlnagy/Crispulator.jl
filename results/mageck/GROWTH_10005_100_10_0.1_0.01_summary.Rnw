...
library(xtable)
comparisons=c("H1,H2,H3,H4_vs_L1,L2,L3,L4 neg.","H1,H2,H3,H4_vs_L1,L2,L3,L4 pos.");
ngenes=c(1000,1000);
...
\newpage\section{Comparison results of H1,H2,H3,H4 vs L1,L2,L3,L4 neg.}

The following figure shows the distribution of RRA score in the comparison H1,H2,H3,H4 vs L1,L2,L3,L4 neg., and the RRA scores of 10 genes.
...
\newpage\section{Comparison results of H1,H2,H3,H4 vs L1,L2,L3,L4 pos.}

The following figure shows the distribution of RRA score in the comparison H1,H2,H3,H4 vs L1,L2,L3,L4 pos., and the RRA scores of 10 genes.
